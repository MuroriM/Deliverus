...
public class FallingItemsView extends View {
    ...
    public FallingItemsView setImages(int[] imageArray){
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (Notes notes : mNotes) {
            canvas.save();
            notes.mNotesIconDrawable.setBounds((int) notes.X, (int) notes.Y,
                    (int) (notes.X + mNotesIconHeight * notes.scale),
                    (int) (notes.Y + mNotesIconHeight * notes.scale));
    ...
    private Drawable resize(Drawable image)
    {
        ...
        {
            Bitmap bitmapResized = Bitmap.createScaledBitmap(b, 76, 76, false);
    ...
    private class Notes {
        ...
        private void init() {
            ...
            if(myImageList==null){
                myImageList = new int[]{R.drawable.falling_bread};
                images = new Drawable[myImageList.length];
            ...
            alpha = mRandom.nextInt(200) + 55; //get a random Alpha 55~255
